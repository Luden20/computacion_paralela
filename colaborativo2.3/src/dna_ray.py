...
def main():
    ...
    if args.ray_address.lower() == "local":
        ray.init()
    else:
    ...
    if args.max_inflight > 0:
        ...
        max_inflight = max(1, min(total_cpus * 2, 6))
    ...
    final_bases, final_patterns, total_other, total_length, workers = reduce_results(results, patterns)
